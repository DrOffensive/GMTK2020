...
public abstract class BasePopup : MonoBehaviour
{
    ...
    public virtual void Setup (BasePopup_Data popupData)
    {
        ...
        float x = UnityEngine.Random.Range(popupData.windowWidth / 2, Screen.width - popupData.windowHeight/2);
        float y = UnityEngine.Random.Range(popupData.windowHeight / 2, Screen.height- popupData.windowHeight/2);
        OnShow += () => 
        {
